...
from .v3.conditioning_bridge_nodes import (
    NODE_CLASS_MAPPINGS as V35_CONDITIONING_BRIDGE_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as V35_CONDITIONING_BRIDGE_NODE_DISPLAY_NAME_MAPPINGS,
)

NODE_CLASS_MAPPINGS.update(V35_CONDITIONING_BRIDGE_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(
    V35_CONDITIONING_BRIDGE_NODE_DISPLAY_NAME_MAPPINGS
)
